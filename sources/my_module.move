module move_project::my_module {
    ...
    public entry fun forge_transfer(forge: Forge, recipient: address, _ctx: &mut TxContext) {
        use sui::transfer; 
        // transfer forge ownership 
    ...
    fun test_sword_transactions() {
        ...
        let test_forge = Forge {
            id: object::new(&mut ctx),
            swords_created: 6,
        }; 
        let forge = &mut test_forge; 

        test_scenario::next_tx(scenario, admin);
        {
            // create the sword and transfer it to the initial owner
            sword_create(forge, 42, 7, initial_owner, test_scenario::ctx(scenario));
        };
